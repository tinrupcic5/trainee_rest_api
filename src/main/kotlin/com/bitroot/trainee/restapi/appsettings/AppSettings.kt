...
class AppSettings {
    companion object {
        ...
        fun contentId(name: String, id: Long): String = "${name}_$id"
    }
}
...
fun String.stringToDate1(): Date {
    return SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSSSSS").parse(this)
}
...
fun isVideo(file: MultipartFile): Boolean =
